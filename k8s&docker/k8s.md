...
![image-20211025143555007](\img\image-20211025143555007.png)
...
### ![image-20211025150031469](img/image-20211025150031469.png)
...
# 初始化主节点
#所有机器添加master域名映射，以下需要修改为自己的对应配置
...
#设置访问端口，将配置文件中的type: ClusterIP 改为 type: NodePort
